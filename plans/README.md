...
| 002 | Attach a tmux monitor to an existing daemon | P1 | M | 001 | TODO |
| 003 | Enforce private fallback permissions | P1 | S | — | TODO |
| 004 | Bound and reclaim daemon subscriptions | P1 | M | 001 | TODO |
